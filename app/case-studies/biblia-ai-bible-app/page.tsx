...
export const metadata: Metadata = {
  ...
  description: 'How we built a Spanish-first AI-powered Bible study app with GPT-4 integration in just 2 weeks. 31,000+ verses, 8 AI tools, SwiftUI native iOS development.',
  keywords: [
    'AI Bible app',
    'iOS Bible study app',
    'GPT-4 Bible app',
  ...
  openGraph: {
    ...
    description: 'Spanish-first AI-powered Bible study app built in 2 weeks with GPT-4 integration.',
